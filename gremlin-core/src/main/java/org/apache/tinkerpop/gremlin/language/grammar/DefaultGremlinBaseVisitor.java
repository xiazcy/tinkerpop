...
public class DefaultGremlinBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements GremlinVisitor<T> {
	 ...
	 */
	@Override
	public T visitTraversalMethod_concat_Scope_Traversal(GremlinParser.TraversalMethod_concat_Scope_TraversalContext ctx) {
		notImplemented(ctx); return null;
	}
	/**
	 * {@inheritDoc}
	 */
	@Override
	public T visitTraversalMethod_concat_Scope_String(GremlinParser.TraversalMethod_concat_Scope_StringContext ctx) {
		notImplemented(ctx); return null;
	}
	/**
	 * {@inheritDoc}
